...
class ast_traversal {
public:
	virtual void* visit(class _ast_epsilon *n) = 0;
...
/* AST node representing epsilon -- for parsing only */
class _ast_epsilon : public ast_tmpl<_ast_epsilon> {
public:
	_ast_epsilon();
};
